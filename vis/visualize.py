...
def visualise_her_results(path):
    ...
    axis[0,0].plot(df_epoch['success_rate'] * 100,  color="#85C1E9", label="Успеваемост %")
    axis[0,0].plot(running_average(df_epoch['success_rate'].to_numpy() * 100, n=10), '-.', color='red', label="Пълзящо средно (10)")
